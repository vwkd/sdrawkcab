...
```
sayHi of myobj is extractedSayHi alias
...
```
1, 2 to new of Rational is one_half alias
```
...
- can think of language creating infinitely many variables, e.g. `... to new of Number is 42 alias`, although breaks down because
...
```
to new of List is mylist alias
