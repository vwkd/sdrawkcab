...
```
1, 2 to new in Rational as one_half
```
...
- can think of language creating infinitely many variables, e.g. `... to new in Number as 42`, although breaks down because
