...
- can get and set variables since scope isn't needed for anything else
...
```
mylist is new list
add "John", "Jim" and "Jill" to mylist
has "Jill" in mylist
get 1 of mylist
delete 2 of mylist
```
...
```
mylist is new set
add "John", "Jim" and "Jill" to myset
has "Jill" in myset
delete "Jim" from myset
```
