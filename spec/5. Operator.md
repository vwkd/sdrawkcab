...
<!-- todo: what happens if overloads prefix/postfix operator with bifix operator? e.g. unary +,- and normal +,- -->
- use `::` and `$` to denote position of function name
...
<!-- todo: shoud allow around-fix? like grouping operator? would need way to define which is opening and which is closing symbol... -->
...
<!-- todo: how to differentiate between unary + and - and normal + and - ? -->
